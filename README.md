...
Подходит для версии OpenCore 0.5.9 и выше, на текущий момент до release 0.7.2
...
Мы постарались сделать максимально лёгким и безопасным переход вашей верисии OpenCore от старых, до релиза 0.7.2, и обновить всю папку EFI, но от текущих ошибок вашего конфига не застрахованы даже вы сами:) Проверить config.plist вы можете native утилитой OpenCore - ocvalidate.
